...
In the previous section we have seen which kind of metric would be ideal for the different parties. Before going to the metrics proposed for each party by this paper, first a list of metrics is presented that is already used by honeypots for botnet detection:
